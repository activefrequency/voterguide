...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'District.is_floterial'
        db.add_column(u'voterguide_district', 'is_floterial',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'District.is_floterial'
        db.delete_column(u'voterguide_district', 'is_floterial')
    ...
    models = {
        ...
        u'voterguide.district': {
            ...
            'is_floterial': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'modified_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            ...
            'state': ('django.db.models.fields.CharField', [], {'default': "'NH'", 'max_length': '2'})
        },
