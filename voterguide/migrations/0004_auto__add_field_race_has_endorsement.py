...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Race.has_endorsement'
        db.add_column(u'voterguide_race', 'has_endorsement',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Race.has_endorsement'
        db.delete_column(u'voterguide_race', 'has_endorsement')
