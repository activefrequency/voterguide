...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Person.blurb'
        db.alter_column(u'voterguide_person', 'blurb', self.gf('django.db.models.fields.TextField')(max_length=500))

        # Changing field 'Person.photo_url'
        db.alter_column(u'voterguide_person', 'photo_url', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Person.blurb'
        db.alter_column(u'voterguide_person', 'blurb', self.gf('django.db.models.fields.CharField')(max_length=500))

        # Changing field 'Person.photo_url'
        db.alter_column(u'voterguide_person', 'photo_url', self.gf('django.db.models.fields.URLField')(max_length=200))
